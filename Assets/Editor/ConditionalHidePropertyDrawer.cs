...
public class ConditionalHidePropertyDrawer : PropertyDrawer
{
    ...
    {
        bool enabled = (conditionalHideAttribute.UseOrLogic) ? false : true;
        ...
        if (!property.isArray)
        {
            ...
            string conditionPath = propertyPath.Replace(property.name, conditionalHideAttribute.ConditionalSourceField); //changes the path to the conditionalsource property path
        ...
        if (sourcePropertyValue != null)
        {
            ...
            if (conditionalHideAttribute.InverseCondition1) enabled = !enabled;
        }
        else
        {
        ...
        if (sourcePropertyValue2 != null)
        {
            ...
            if (conditionalHideAttribute.InverseCondition2) prop2Enabled = !prop2Enabled;

            if (conditionalHideAttribute.UseOrLogic)
        ...
        string[] conditionalSourceFieldArray = conditionalHideAttribute.ConditionalSourceFields;
        bool[] conditionalSourceFieldInverseArray = conditionalHideAttribute.ConditionalSourceFieldInverseBools;
